...
<section class="section">
    <div class="section-header">
        ...
        <div class="section-header-breadcrumb">
            ...
            <div class="breadcrumb-item active">
                <a href="{{ route('slider.index') }}">Listar</a>
            </div>
                    ...
                    <div class="card-body">
                        <form action="{{ route('slider.store') }}" method="post" enctype="multipart/form-data">
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" name="starting_prince" class="form-control" placeholder="Adicione o valor" value="{{ old('starting_prince') }}">
                            </div>
                            ...
                            <div class="form-group">
                                ...
                                <input type="number" name="serial" class="form-control" placeholder="Informe ordem de exibição" value="{{ old('serial') }}">
                            </div>
